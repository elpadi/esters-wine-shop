...
if(typeof noGlobal==="undefined"){window.jQuery=window.$=jQuery}return jQuery})},{}],2:[function(require,module,exports){const SingleProductPage=require("../../../modules/shop/product");if("app"in window){window.app.addModule("productpage",SingleProductPage)}else console.error("App is not loaded")},{"../../../modules/shop/product":3}],3:[function(require,module,exports){const $=require("jquery");class Product{constructor(){$(".products").each((i,el)=>{$(el).addClass("product-sublisting").find("h2").not(".woocommerce-loop-product__title").addClass("star-heading")});$(".woocommerce-product-gallery__image").addClass("double-border")}}module.exports=Product},{"jquery":1}]},{},[2]);
