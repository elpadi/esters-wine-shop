...
if(typeof noGlobal==="undefined"){window.jQuery=window.$=jQuery}return jQuery})},{}],2:[function(require,module,exports){const CheckoutGift=require("../../../modules/shop/checkout-gift");if("app"in window){window.app.addModule("checkoutgift",CheckoutGift)}else console.error("App is not loaded")},{"../../../modules/shop/checkout-gift":3}],3:[function(require,module,exports){const $=require("jquery");class CheckoutGift{constructor(){this.container=document.querySelector("#checkout__gift");$("#main").on("change","#is_order_gift",this.toggle.bind(this))}toggle(e){this.container.classList.toggle("show-fields",e.target.checked)}}module.exports=CheckoutGift},{"jquery":1}]},{},[2]);
