...
if(typeof noGlobal==="undefined"){window.jQuery=window.$=jQuery}return jQuery})},{}],2:[function(require,module,exports){const ProductListingPage=require("../../../modules/shop/product-listing");if("app"in window){window.app.addModule("listingpage",ProductListingPage)}else console.error("App is not loaded")},{"../../../modules/shop/product-listing":3}],3:[function(require,module,exports){const $=require("jquery");class ProductListing{constructor(){document.querySelector("#content").style.backgroundImage=`url(${app.ENV.URLS.THEME}/assets/img/bg-patterns/shop.jpg)`}}module.exports=ProductListing},{"jquery":1}]},{},[2]);
