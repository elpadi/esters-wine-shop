...
if(typeof noGlobal==="undefined"){window.jQuery=window.$=jQuery}return jQuery})},{}],2:[function(require,module,exports){const ShoppingCartPage=require("../../../modules/shop/cart");if("app"in window){window.app.addModule("cartpage",ShoppingCartPage)}else console.error("App is not loaded")},{"../../../modules/shop/cart":3}],3:[function(require,module,exports){const $=require("jquery");class Cart{constructor(){$(document.body).on("updated_cart_totals",e=>{console.log("Cart.constructor",arguments)})}}module.exports=Cart},{"jquery":1}]},{},[2]);
