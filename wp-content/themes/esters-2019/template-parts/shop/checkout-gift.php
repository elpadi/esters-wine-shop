<section id="checkout__gift" data-show-fields="false">
	...
	<main class="fields">
		...
		<?php foreach (ThemeLib\Esters\Shop\Shop::getGiftFields() as $name => $def): $fieldname = "recipient_$name"; woocommerce_form_field($fieldname, [
			'type'          => $def[1],
			'class'         => ['my-field-class form-row-wide'],
			'label'         => false,
			'placeholder'   => __($def[0]),
		], $checkout->get_value($fieldname)); endforeach; ?>
	</main>
</section>
