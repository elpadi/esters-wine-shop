...
$h_tpl = function ($s) use ($theme) {
    include __DIR__ . "/template-parts/header/$s.php";
};
$burgerClass = 'burger-btn clean-btn icon-btn btn';
?><!doctype html>
...
<body <?php body_class(); ?>><?php wp_body_open(); ?>
    <div id="page" class="site">
        <header id="masthead" class="site-header">
            ...
            <div id="theme-header__book-table"><?php $h_tpl('book-table'); ?></div>
            <button class="<?= $burgerClass; ?> burger-expand-btn"><?= $theme->svg('burger', 'icons'); ?></button>
            <button class="<?= $burgerClass; ?> burger-collapse-btn"><?= $theme->svg('no-alt', 'icons'); ?></button>
        </header><!-- #masthead -->
        <nav id="theme-nav">
