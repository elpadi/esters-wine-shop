...
add_action('woocommerce_review_order_before_payment', function() {
	echo '<p><a id="shipping-info-toggler" href="#" data-toggle="modal" data-target="#shipping_details">Shipping &amp; Delivery Details</a></p>';
	include dirname(__DIR__).'/templates/shipping-info-modal.php';
});

add_filter('woocommerce_thankyou_order_received_text', function($text) {
	return $text . sprintf('<p><a class="ty-shop-btn button" href="%s">%s</a></p>', wc_get_page_permalink('shop'), __('Continue shopping.', 'woocommerce'));
});
